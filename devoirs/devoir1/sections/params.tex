...
\newcommand{\myname}{\hspace{1.7cm} \footnotesize{J.-B. Bertrand}, \footnotesize{P.-A. Graham}}
\newcommand{\myhwtype}{Devoir}
\newcommand{\myhwnum}{1}
\newcommand{\myclass}{Physique subatomique, PHQ638}


\header{\textbf{\myclass\ \mylecture\mysection}}%
{\textbf{\hspace{3cm} \myname}}
